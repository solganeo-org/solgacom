...
const Connection = React.lazy(() => import('./views/theme/connection/Connection'))
const Code = React.lazy(() => import('./views/theme/connection/Code'))
...
const routes = [
  ...
  { path: '/dashboard/connection', name: 'Connection', component: Connection, exact: true },
  {
    path: '/dashboard/connection/generatekeys',
    name: 'Generate Keys',
    component: Connection,
    exact: false,
  },
  { path: '/dashboard/connection/code', name: 'Code', component: Code, exact: false },
  ...
  // // { path: '/connection/typography', name: 'Typography', component: Typography },
